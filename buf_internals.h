...
typedef struct BufferDesc
{
	...
	//Variable needed for LRU: show previous node in linked list is added and initialized in init
	int 		freePrevious; // (anfal)
...
#define FREE_PREVIOUS_NOT_IN_LIST (-2) //(anfal) 
